# יום 3 – מצגת 11: Authentication & Authorization 2026

---

## שקף 1
**כותרת ראשית:** Authentication & Authorization 2026
**כותרת משנה:** JWT, Refresh Tokens, Rotation, argon2, OAuth2/OIDC

---

## שקף 2
**כותרת ראשית:** Stateful vs Stateless
...
## שקף 3
**כותרת ראשית:** JWT Anatomy – שלושה חלקים
...
- החתימה מבטיחה ש**תוכן לא שונה**, לא שהתוכן חסוי

---

## שקף 4
**כותרת ראשית:** Access Token + Refresh Token
...
## שקף 5
**כותרת ראשית:** Token Rotation Strategy
...
## שקף 6
**כותרת ראשית:** Blacklist Strategy
...
- ```js
  // בכניסה/logout: הוסף jti לרשימה שחורה
...
## שקף 7
**כותרת ראשית:** הצפנת סיסמאות – argon2
...
## שקף 8
**כותרת ראשית:** Token Expiration Design
...
## שקף 9
**כותרת ראשית:** OAuth2 + OIDC Overview
...
## שקף 10
**כותרת ראשית:** Threat Modeling בסיסי
...
## שקף 12
**כותרת ראשית:** Authorization – RBAC
...
## שקף 13
**כותרת ראשית:** סיכום – יום 3 מצגת 11
