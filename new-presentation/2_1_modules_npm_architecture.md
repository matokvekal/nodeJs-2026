# יום 2 – מצגת 5: Modules, NPM & Backend Architecture

---

## שקף 1
**כותרת ראשית:** Modules, NPM & Backend Architecture
**כותרת משנה:** ESM, package.json, dotenv, ESLint, מבנה פרויקט

---

## שקף 2
**כותרת ראשית:** ESM – ברירת המחדל ב-2026
...
## שקף 3
**כותרת ראשית:** הבדלים מעשיים CJS vs ESM
...
## שקף 4
**כותרת ראשית:** package.json – תעודת הזהות
...
## שקף 6
**כותרת ראשית:** שדה exports ב-package.json
...
## שקף 7
**כותרת ראשית:** dotenv ומשתני סביבה
...
## שקף 9
**כותרת ראשית:** Prettier – עיצוב קוד אחיד
...
- `"format": "prettier --write src/"` בـ`scripts`
...
## שקף 10
**כותרת ראשית:** מבנה תיקיות Backend מודרני
```
src/
...
## שקף 11
**כותרת ראשית:** Layered Architecture – הפרדת שכבות
...
## שקף 12
**כותרת ראשית:** Clean Error Boundaries
- כל שכבה אחראית על שגיאות שלה ומה מעלה לשכבה הבאה
- Service זורקת `AppError` עם `statusCode` וـ`message`
...
## שקף 13
**כותרת ראשית:** סיכום – יום 2 מצגת 5
