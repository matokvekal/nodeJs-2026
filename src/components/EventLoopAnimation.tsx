...
type PhaseDescriptions = {
  [key: string]: string;
};

const EventLoopAnimation = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    const microtaskRadius: number = 80;
  ...
  const phaseDescriptions: PhaseDescriptions = {
          ...
          <div className="concept-explanation">
            ...
            <div className="concept-item">
              ...
              <div>
                ...
                <p>
                  רצים מיד אחרי כל callback לפני המשך ה-Loop: Promise.then,
                  nextTick
                </p>
              </div>
            </div>
            <div className="concept-item">
              ...
              <div>
                ...
                <p>
                  ה-Loop עובר מ-Timers → I/O → Poll → Check → Close ושוב מתחיל
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="el-priority-list">
                ...
                <div className="el-priority-item el-priority-2">
                  ...
                  <div>
                    ...
                    <p>
                      <code>.then()</code> / <code>await</code> — רצים אחרי
                      nextTick
                    </p>
                  </div>
                </div>
                <div className="el-priority-item el-priority-3">
                  ...
                  <div>
                    <strong>Macrotasks</strong>
                    <p>
                      <code>setTimeout</code> / <code>setImmediate</code> — רצים
                      אחרון
                    </p>
                  </div>
                </div>
...
process.nextTick(() => console.log("nextTick"))`}</pre>
            ...
            <div className="el-info-section">
              ...
              <div className="el-output-list">
                <div className="el-output-item">
                  <span className="el-output-num">1</span>
                  <code>nextTick</code>
                </div>
                <div className="el-output-item">
                  <span className="el-output-num">2</span>
                  <code>promise</code>
                </div>
                <div className="el-output-item el-output-note">
                  <span className="el-output-num">3</span>
                  <code>timer / immediate</code>
                  <span className="el-output-tag">תלוי הקשר</span>
                </div>
              </div>
            </div>
          </div>
