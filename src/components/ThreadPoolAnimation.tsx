...
const ThreadPoolAnimation = (): JSX.Element => {
  const canvasRef = useRef<HTMLCanvasElement | null>(null);
  const [poolSize] = useState<number>(4);
  ...
  useEffect(() => {
    ...
    let threads: Thread[] = Array.from({ length: poolSize }, (_, i) => ({
      id: i,
      x: 100 + i * 150,
      y: 200,
      busy: false,
    ...
    const taskInterval: NodeJS.Timeout = setInterval(addTask, 2000);
          ...
          <div className="concept-explanation">
            <div className="concept-item">
              ...
              <div>
                ...
                <p>
                  משימות ממתינות לטיפול. כל משימה תיקח thread פנוי כשיהיה זמין
                </p>
              </div>
            </div>
            <div className="concept-item">
              ...
              <div className="tp-uses-grid">
                <div className="tp-use-card tp-use-fs">
                  ...
                  <div>
                    ...
                    <p>
                      רוב מערכות ההפעלה לא מספקות async אמיתי לקבצים →<br />
                      libuv מריץ אותן ב-worker thread
                    </p>
