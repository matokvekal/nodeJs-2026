...
import { quiz_4_2 } from "../../data/quizzes/quiz_4_2";
...
export const slides: Slide[] = [
  {
    ...
    subtitle: "Hash, HMAC, randomBytes, Symmetric vs Asymmetric"
  },
  {
    id: 2,
    title: "מודול crypto",
...
const match = timingSafeEqual(
  ...
  {
    id: 6,
    title: "randomBytes – ערכים אקראיים",
...
function encrypt(text) {
  ...
  {
    id: 8,
    title: "Asymmetric – RSA / ECDSA",
    code: `import { generateKeyPairSync } from 'node:crypto';
...
const { privateKey, publicKey } = generateKeyPairSync('ec', {
  ...
  },
  {
    ...
    panels: [
      {
        comparison: {
          headers: ["", "Symmetric (AES)", "Asymmetric (RSA/ECDSA)"],
          rows: [
  ...
  {
    id: 10,
    title: "Web Crypto API (Modern)",
    code: `// גיבוב עם Web Crypto (גלובלי ב-Node 20+)
...
const hexHash = Buffer.from(hash).toString('hex');`,
  ...
  {
    id: 11,
    title: "מתי לא לכתוב Crypto בעצמך",
    bullets: [
